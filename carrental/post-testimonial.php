...
$sql = "
    INSERT INTO danh_gia (ND_SoDt, DG_NoiDung)
    SELECT ND_SoDt, :testimonoial
    FROM nguoi_dung
    WHERE ND_Email = :email
";
...
{
$error="Đánh giá gửi không thành công. Vui lòng đánh giá lại!";
}
...
<title>Xe thuận tiện |Gửi đánh giá</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Gửi một đánh giá</h5>
