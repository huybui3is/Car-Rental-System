...
{
$error="Thêm xe không thành công. Vui lòng thử lại";
}
...
<head>
	...
	<title>Xe thuận tiện | Quản lý thêm xe</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Thêm một xe mới</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Mô tả tổng quan xe<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<label for="powerdoorlocks"> Khóa cửa điện tử </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="cdplayer"> Máy phát nhạc CD </label>
</div>
</div>
<div class="col-sm-3">
...
<label for="leatherseats"> Bộ Ghế da </label>
</div>
</div>
</div>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2">
													...
													<button class="btn btn-primary" name="submit" type="submit">Thêm xe</button>
												</div>
											</div>
