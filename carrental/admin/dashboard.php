...
<head>
	...
	<title>Xe thuận tiện | Trang chủ quản trị</title>
...
<?php 
$sql ="SELECT ND_SoDt from nguoi_dung ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Danh sách người dùng</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql2 ="SELECT DH_Ma from don_hang ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Tổng đơn thuê xe</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
$sql3 ="SELECT HX_Ma from hang_xe ";
...
?>												
													...
													<div class="stat-panel-title text-uppercase">Danh sách hãng xe</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$sql4 ="SELECT id from nguoidangky ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Người đăng ký khuyến mãi</div>
												</div>
											</div>
											<a href="manage-subscribers.php" class="block-anchor panel-footer">Xem chi tiết <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
$sql6 ="SELECT id from cauhoilienhe ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
$sql5 ="SELECT DG_Ma from danh_gia ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Các đánh giá</div>
												</div>
											</div>
