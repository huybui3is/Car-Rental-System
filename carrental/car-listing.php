...
<?php $sql = "SELECT XE.*, HANG_XE.HX_Ten, HANG_XE.HX_Ma as bid from XE join HANG_XE on HANG_XE.HX_Ma=XE.HX_Ma";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT xe.*, hang_xe.HX_Ten, hang_xe.HX_Ma as bid FROM xe JOIN hang_xe ON hang_xe.HX_Ma = xe.HX_Ma ORDER BY xe.XE_Ma DESC LIMIT 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
