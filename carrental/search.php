...
$sql = "SELECT xe.XE_Ma from xe 
join hang_xe on hang_xe.HX_Ma=xe.HX_Ma 
where xe.XE_Ten=:search || xe.XE_LoaiNhienLieu=:search || hang_xe.HX_Ten=:search || xe.XE_MauNam=:search";
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Danh sách tìm thấy</span></p>
</div>
</div>

<?php 
$sql = "SELECT xe.*,hang_xe.HX_Ten,hang_xe.HX_Ma as bid  from xe 
join hang_xe on hang_xe.HX_Ma=xe.HX_Ma 
where xe.XE_Ten=:search || xe.XE_LoaiNhienLieu=:search || hang_xe.HX_Ten=:search || xe.XE_MauNam=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
...
{  ?>
        <div class="product-listing-m gray-bg">
          <div class="product-listing-img"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->XE_Anh1);?>" class="img-responsive" alt="Image" /> </a> 
          </div>
          <div class="product-listing-content">
            ...
            <p class="list-price">VND<?php echo htmlentities($result->XE_GiaThue);?> Mỗi ngày</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->XE_ChoNgoi);?> chỗ ngồi</li>
              <li><i class="fa fa-calendar" aria-hidden="true"></i>mẫu <?php echo htmlentities($result->XE_MauNam);?></li>
              <li><i class="fa fa-car" aria-hidden="true"></i><?php echo htmlentities($result->XE_LoaiNhienLieu);?></li>
            </ul>
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->XE_Ma);?>" class="btn">Xem chi tiết <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> DANH SÁCH XE GẦN ĐÂY</h5>
          </div>
