...
$email=$_SESSION['login'];
  $sql ="SELECT ND_PassWord FROM nguoi_dung WHERE ND_Email=:email and ND_PassWord=:password";
...
if($query -> rowCount() > 0)
{
$con="update nguoi_dung set ND_PassWord=:newpassword where ND_Email=:email";
...
<title>Xe thuận tiện - Thay đổi mật khẩu</title>
<!--Bootstrap -->
...
<form name="chngpwd" method="post" onSubmit="return valid();">
            ...
            <div class="form-group">
               <input type="submit" value="Thay đổi mật khẩu" name="updatepass" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
